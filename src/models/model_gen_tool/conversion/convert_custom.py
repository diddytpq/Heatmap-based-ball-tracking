...
import sys
sys.path.append("..")
from models.network_b0_ver2 import EfficientNet_b0
...
def arg_parse():
    ...
    parser.add_argument('--tf_weight', type=str, default='efficientnet-b3',
                        help='Directory name to save the TF chekpoint')
    parser.add_argument('--pth_weight', type=str, default='custom_b3',
...
if __name__ == "__main__":
    ...
    mbconvs = [mbconv for mbblock in [model.MBBlock_1, model.MBBlock_2, model.MBBlock_3, model.MBBlock_4, model.MBBlock_5, model.MBBlock_6, model.MBBlock_7] for mbconv in mbblock.layers]
