...
parser.add_argument('--video_name', type = str, default = '2.mp4', help = 'input video name for predict')
parser.add_argument('--lr', type = float, default = 1e-1, help = 'learning rate (default: 0.1)')
parser.add_argument('--load_weight', type = str, default = 'TrackNet3_30.tar', help = 'input model weight for predict')
...
while True:
	...
	heapmap = np.reshape(heapmap,(HEIGHT,WIDTH,3))
